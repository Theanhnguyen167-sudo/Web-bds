      ...
      <footer className="bg-[#0a0f1e] text-slate-400 text-xs py-16 border-t border-slate-800">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-slate-400">
              <li><Link href="/planning" className="hover:text-white transition-colors">Về chúng tôi</Link></li>
              <li><Link href="/streets" className="hover:text-white transition-colors">Đội ngũ</Link></li>
              <li><Link href="/pricing" className="hover:text-white transition-colors">Tuyển dụng</Link></li>
