...
interface ListingCardProps {
  listing: ListingItem;
  onPhotoClick?: (listing: ListingItem) => void;
}
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className="absolute top-2.5 right-2.5 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-white/90 shadow-md backdrop-blur-sm transition-colors hover:bg-white cursor-pointer"
          ...
          {/* Hover Slide-up View Photos Button */}
          <motion.div
          ...
          >
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg bg-accent px-2.5 py-1 text-xs font-bold text-white shadow-lg hover:bg-accent-hover transition-colors cursor-pointer"
            >
      ...
      <LightboxModal
        ...
        propertyPrice={formatCurrencyVND(listing.price)}
      />
    </>
  );
};
